...
public class DownloadAndPlayAudio extends Activity
{
    // Progress Dialog type (0 - for Horizontal progress bar)
    public static final int progress_bar_type = 0;
    // Music resource URL
//		private static String file_url = "http://android.programmerguru.com/wp-content/uploads/2014/01/jai_ho.mp3";
    private static String file_url = "http://download.f9.stream.nixcdn.com/5cf67b482b0be4b90c065cdd05587e36/54885b0d/NhacCuaTui879/ChoAnhMotDieuUoc-HoangTonLK-3671811_hq.mp3";
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        btnPlayMusic.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                ...
                File file = new File(Environment.getExternalStorageDirectory().getPath() + "/jai_ho1.mp3");
    ...
    protected void playMusic()
    {
        ...
        Uri myUri1 = Uri.parse("file:///sdcard/jai_ho1.mp3");
